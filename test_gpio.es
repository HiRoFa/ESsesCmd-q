{
    // test a stepper motor
     async function test_stepper(){
        ...
        let Stepper = await import('https://raw.githubusercontent.com/HiRoFa/ESsesLib-q/main/modules/utils/stepper.mes');
        // init a Stepper
    ...
    async function test_led(){
        // load the Led class
        let Led = await import('https://raw.githubusercontent.com/HiRoFa/ESsesLib-q/main/modules/utils/led.mes');
        // init an Led
